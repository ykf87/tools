...
func (x xiGua) parseShareUrl(shareUrl string, transport *http.Transport) (*VideoParseInfo, error) {
	client := resty.New()
	if transport != nil {
	...
	return x.parseVideoID(videoId, transport)
}

func (x xiGua) parseVideoID(videoId string, transport *http.Transport) (*VideoParseInfo, error) {
