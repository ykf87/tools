...
func (l liShiPin) parseVideoID(videoId string, transport *http.Transport) (*VideoParseInfo, error) {
...
func (l liShiPin) parseShareUrl(shareUrl string, transport *http.Transport) (*VideoParseInfo, error) {
	...
	return l.parseVideoID(videoId, transport)
}
