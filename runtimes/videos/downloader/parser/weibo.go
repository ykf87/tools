...
func (w weiBo) parseShareUrl(shareUrl string, transport *http.Transport) (*VideoParseInfo, error) {
...
func (w weiBo) parseVideoID(videoId string, transport *http.Transport) (*VideoParseInfo, error) {
