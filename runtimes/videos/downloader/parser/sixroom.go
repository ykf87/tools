...
func (s sixRoom) parseShareUrl(shareUrl string, transport *http.Transport) (*VideoParseInfo, error) {
	...
	return s.parseVideoID(videoId, transport)
}

func (s sixRoom) parseVideoID(videoId string, transport *http.Transport) (*VideoParseInfo, error) {
