...
func (w weiShi) parseVideoID(videoId string, transport *http.Transport) (*VideoParseInfo, error) {
...
func (w weiShi) parseShareUrl(shareUrl string, transport *http.Transport) (*VideoParseInfo, error) {
	...
	return w.parseVideoID(videoId, transport)
}
