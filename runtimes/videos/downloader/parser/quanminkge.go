...
func (q quanMinKGe) parseShareUrl(shareUrl string, transport *http.Transport) (*VideoParseInfo, error) {
	...
	return q.parseVideoID(urlInfo.Query()["s"][0], transport)
}

func (q quanMinKGe) parseVideoID(videoId string, transport *http.Transport) (*VideoParseInfo, error) {
