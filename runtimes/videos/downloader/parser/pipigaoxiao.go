...
func (p piPiGaoXiao) parseVideoID(videoId string, transport *http.Transport) (*VideoParseInfo, error) {
...
func (p piPiGaoXiao) parseShareUrl(shareUrl string, transport *http.Transport) (*VideoParseInfo, error) {
	...
	return p.parseVideoID(videoId, transport)
}
