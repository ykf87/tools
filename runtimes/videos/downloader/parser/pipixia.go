...
func (p piPiXia) parseVideoID(videoId string, transport *http.Transport) (*VideoParseInfo, error) {
...
func (p piPiXia) parseShareUrl(shareUrl string, transport *http.Transport) (*VideoParseInfo, error) {
	client := resty.New()
	if transport != nil {
		client.SetTransport(transport)
	}
