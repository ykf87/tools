...
func (h huYa) parseShareUrl(shareUrl string, transport *http.Transport) (*VideoParseInfo, error) {
	...
	return h.parseVideoID(string(findRes[1]), transport)
}

func (h huYa) parseVideoID(videoId string, transport *http.Transport) (*VideoParseInfo, error) {
