...
func (b biliBili) parseShareUrl(shareUrl string, transport *http.Transport) (*VideoParseInfo, error) {
	...
	viewRespBytes, err := b.sendBiliRequest(viewAPIURL, transport)
	if err != nil {
	...
	playRespBytes, err := b.sendBiliRequest(playAPIURL, transport)
	if err != nil {
...
func (b biliBili) sendBiliRequest(apiURL string, transport *http.Transport) ([]byte, error) {
