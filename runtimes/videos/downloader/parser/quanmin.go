...
func (q quanMin) parseShareUrl(shareUrl string, transport *http.Transport) (*VideoParseInfo, error) {
	...
	return q.parseVideoID(videoId, transport)
}

func (q quanMin) parseVideoID(videoId string, transport *http.Transport) (*VideoParseInfo, error) {
